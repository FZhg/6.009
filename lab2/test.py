...
class TestTiny(unittest.TestCase):
    ...
    # test case 1,2 is for did_x_and_y_act_together
    ...
    # test cases, 3 and 4 is for get_actors_with_bacon_number
    ...
    # test cases, 5,6, and 7 are for get_path
...
class TestActedTogether(unittest.TestCase):
    ...
    def test_01(self):
        ...
        actor1 = 4724
        actor2 = 9210
        self.assertTrue(lab.did_x_and_y_act_together(
            self.data, actor1, actor2))

    def test_02(self):
        # Simple test, two actors who had not acted together
        actor1 = 4724
        actor2 = 16935
        self.assertFalse(lab.did_x_and_y_act_together(
            self.data, actor1, actor2))
