...
def get_actors_with_bacon_number(data, n):
    """
    Returns the list of people who have a given Bacon number.
    """
    acted_with = make_neighbor_db(data)
    # Intialize the parents and the first level of the Bacon number (level 0).
    ...
    return list(cur_level)  # spec requires that we return a list.
